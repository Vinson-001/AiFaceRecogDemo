#include "mytableviewbase.h"
//#include "mytableviewdelegate.h"
MyTableViewBase::MyTableViewBase(QWidget *parent)
    :QTableView(parent),
      m_model(NULL)
{
...
MyTableViewBase::~MyTableViewBase()
{
    if(m_model){
        delete m_model;
        m_model = NULL;
...
void MyTableViewBase::initTableView()
{
...
void MyTableViewBase::addRowTextForTable(int rowConut, QList<QString> strTextList)
{
    QString strNum;
...
void MyTableViewBase::addRowForTable(QList<QString> strTextList)
{
...
void MyTableViewBase::removeRowForTable()
{
...
void MyTableViewBase::removeAllRowForTable()
{
    if(m_model == NULL)
        return;
...
void MyTableViewBase::sortColForTable()
{
 ...
 * @return    no
 */
void MyTableViewBase::SetTabViewColumnSpace()
{
    //根据内容来确定列宽度
...
void MyTableViewBase::doTable(QString operate, QList<QString> strTextList)
{
    if(operate == "add") {
...
QString MyTableViewBase::getValueFromRowAndCol(int row, int col)
{
 ...
 * @return    ret
 */
QList<QString> MyTableViewBase::getValueFromRow(int row)
{
 ...
 * @return    no
 */
void MyTableViewBase::setTableColWidth(int width)
{
...
/**
 * @funcname  setTableModel
 * @brief     设置表格模型
 * @param     model
 * @return    no
 */
void MyTableViewBase::setTableModel(QStandardItemModel *model)
{
    m_model = model;
}
